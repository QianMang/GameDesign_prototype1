...
public class GameObjectPool : MonoBehaviour
{
    ...
    public GameObject Object_Instantiate(GameObject newObject, float x, float y, float z)
    {
        ...
        else
        {
            ...
            Vector3 changeV = new Vector3(Random.Range(-9, 10), Random.Range(-9, 10), 0);
            Vector3 direction =  (player.transform.position+changeV)-newPosition;
            obj.GetComponent<Bubble>().bubble_direction = Vector3.Normalize(direction);
